...
namespace Jint.Native
{
    partial class JsGlobal
    {
        ...
        {
            public static object Now(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return runtime.Global.CreateDate(DateTime.Now);
            }

            internal static object Constructor(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                DateTime result;
            ...
            // 15.9.4.1
            public static object Parse(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                double d;
                if (ParseDate(runtime.Global, JsValue.ToString(arguments[0]), CultureInfo.InvariantCulture, out d))
                    return d;
            ...
            // 15.9.5.3
            public static object ToDateString(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return GetDateTimeValue(@this).ToLocalTime().ToString(JsNames.DateFormat, CultureInfo.InvariantCulture);
            }

            // 15.9.5.4
            public static object ToTimeString(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return GetDateTimeValue(@this).ToLocalTime().ToString(JsNames.TimeFormat, CultureInfo.InvariantCulture);
            }

            // 15.9.5.6
            public static object ToLocaleDateString(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return GetDateTimeValue(@this).ToLocalTime().ToString(JsNames.DateFormat);
            }

            // 15.9.5.7
            public static object ToLocaleTimeString(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
            ...
            // 15.9.5.9
            public static object GetTime(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return JsConvert.ToNumber(GetDateTimeValue(@this));
            }

            // 15.9.5.10
            public static object GetFullYear(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToLocalTime().Year;
            }

            // 15.9.5.11
            public static object GetUTCFullYear(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToUniversalTime().Year;
            }

            // 15.9.5.12
            public static object GetMonth(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)(GetDateTimeValue(@this).ToLocalTime().Month - 1);
            }

            // 15.9.5.13
            public static object GetUTCMonth(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
            ...
            // 15.9.5.14
            public static object GetDate(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToLocalTime().Day;
            }

            // 15.9.5.15
            public static object GetUTCDate(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToUniversalTime().Day;
            }

            // 15.9.5.16
            public static object GetDay(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)((int)GetDateTimeValue(@this).ToLocalTime().DayOfWeek);
            }

            // 15.9.5.17
            public static object GetUTCDay(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)((int)GetDateTimeValue(@this).ToUniversalTime().DayOfWeek);
            }

            // 15.9.5.18
            public static object GetHours(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToLocalTime().Hour;
            }

            // 15.9.5.19
            public static object GetUTCHours(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToUniversalTime().Hour;
            }

            // 15.9.5.20
            public static object GetMinutes(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToLocalTime().Minute;
            }

            // 15.9.5.21
            public static object GetUTCMinutes(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToUniversalTime().Minute;
            }

            // 15.9.5.
            public static object ToUTCString(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return GetDateTimeValue(@this).ToString(JsNames.DateTimeFormatUtc, CultureInfo.InvariantCulture);
            }

            // 15.9.5.22
            public static object GetSeconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToLocalTime().Second;
            }

            // 15.9.5.23
            public static object GetUTCSeconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToUniversalTime().Second;
            }

            // 15.9.5.24
            public static object GetMilliseconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToLocalTime().Millisecond;
            }

            // 15.9.5.25
            public static object GetUTCMilliseconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return (double)GetDateTimeValue(@this).ToUniversalTime().Millisecond;
            }

            // 15.9.5.26
            public static object GetTimezoneOffset(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                return -TimeZone.CurrentTimeZone.GetUtcOffset(new DateTime()).TotalMinutes;
            }

            // 15.9.5.27
            public static object SetTime(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.28
            public static object SetMilliseconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.29
            public static object SetUTCMilliseconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
                    throw new ArgumentException("There was no millisecond specified");
            ...
            // 15.9.5.30
            public static object SetSeconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.31
            public static object SetUTCSeconds(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
                    throw new ArgumentException("There was no second specified");
            ...
            // 15.9.5.33
            public static object SetMinutes(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.34
            public static object SetUTCMinutes(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
                    throw new ArgumentException("There was no minute specified");
            ...
            // 15.9.5.35
            public static object SetHours(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.36
            public static object SetUTCHours(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
                    throw new ArgumentException("There was no hour specified");
            ...
            // 15.9.5.36
            public static object SetDate(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.37
            public static object SetUTCDate(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
                    throw new ArgumentException("There was no date specified");
            ...
            // 15.9.5.38
            public static object SetMonth(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.39
            public static object SetUTCMonth(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
                    throw new ArgumentException("There was no month specified");
            ...
            // 15.9.5.40
            public static object SetFullYear(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
            ...
            // 15.9.5.41
            public static object SetUTCFullYear(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
                if (arguments.Length == 0)
                    throw new ArgumentException("There was no year specified");
            ...
            public static object UTC(JintRuntime runtime, object @this, JsObject callee, object[] arguments)
            {
